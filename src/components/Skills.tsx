...
export default function Skills() {
  const categories = [
    ...
    {
      title: "AI & Automation",
      skills: ["AI Workflow Automation", "Prompt Engineering", "LLM Integration", "n8n Pipelines", "Python Scripts", "Firebase", "Docker"],
    ...
    },
    {
      ...
      skills: ["Database Management", "Data Structures", "System Design", "Git & GitHub", "Multi-Agent Systems", "OpenClaw", "Multiple IDEs"],
