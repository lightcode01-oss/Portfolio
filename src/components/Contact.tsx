    ...
    <footer className="w-full py-32 bg-[#050505] px-6 sm:px-12 text-white z-20 relative border-t border-white/5 overflow-hidden flex flex-col items-center text-center">
      ...
      <div className="max-w-4xl w-full relative z-10">
        ...
        >
          ...
          <a
            href="https://wa.me/919583346242"
            target="_blank" rel="noreferrer"
            className="px-8 py-4 bg-emerald-500/10 text-emerald-400 font-semibold rounded-full border border-emerald-500/20 hover:bg-emerald-500/20 transition-all hover:border-emerald-500/50 backdrop-blur-xl hover:scale-105 active:scale-95 duration-300 flex items-center gap-2"
          >
          ...
          <a
            href="https://www.linkedin.com/in/abhinav-dash-92033b267"
            target="_blank" rel="noreferrer"
